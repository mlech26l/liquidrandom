...
from liquidrandom.models.aerial import Aerial
...
from liquidrandom.models.indoor import Indoor
...
from liquidrandom.models.navigation import Navigation
from liquidrandom.models.people_scene import PeopleScene
...
from liquidrandom.models.tool_group import ToolGroup
from liquidrandom.models.warehouse import Warehouse
...
CATEGORIES: dict[str, CategoryInfo] = {
    ...
    "aerial": CategoryInfo(Aerial, "aerial.parquet"),
    "indoor": CategoryInfo(Indoor, "indoor.parquet"),
    "people_scene": CategoryInfo(PeopleScene, "people_scene.parquet"),
    "warehouse": CategoryInfo(Warehouse, "warehouse.parquet"),
    "navigation": CategoryInfo(Navigation, "navigation.parquet"),
}
